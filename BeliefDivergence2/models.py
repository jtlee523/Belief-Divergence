...
1-3= prior (ex ante urn probability)
4-6= signal structure (black/white ball probability for each urn)
7=ball color (0/1 based on black/white ball color)
8-10= points for the color urn (risky option)
11= points for the grey urn (status quo option)
"""
